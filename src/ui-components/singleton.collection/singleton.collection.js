...
import widgetTileModelSchema from './singleton.collection.schema';
import _ from 'lodash';

class Collection { // Design pattern --> Singleton class!
  constructor(){
  ...
  filterCollections(collectionName, searchKey, searchValue, searchPattern){
    var collection = Collections.getCollections(collectionName).data;
...
let Collections = Object.freeze(new Collection());
